...
#[ORM\Entity(repositoryClass: AstonishingVideoRepository::class)]
#[ORM\HasLifecycleCallbacks]
class AstonishingVideo
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[ORM\ManyToMany(targetEntity: FiercePublisher::class, mappedBy: 'astonishingVideos')]
    ...
    public function addFiercePublisher(FiercePublisher $fiercePublisher): static
    {
        if (!$this->fiercePublishers->contains($fiercePublisher)) {
            ...
            $fiercePublisher->addAstonishingVideo($this);
        }
        return $this;
    }
    ...
    public function removeFiercePublisher(FiercePublisher $fiercePublisher): static
    {
        if ($this->fiercePublishers->removeElement($fiercePublisher)) {
            $fiercePublisher->removeAstonishingVideo($this);
        }
        return $this;
    }
