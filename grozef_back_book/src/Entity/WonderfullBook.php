...
#[ORM\Entity(repositoryClass: WonderfullBookRepository::class)]
#[ORM\HasLifecycleCallbacks]
class WonderfullBook
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[ORM\ManyToMany(targetEntity: FiercePublisher::class, mappedBy: 'wonderfullBooks')]
    ...
    public function addFiercePublisher(FiercePublisher $fiercePublisher): static
    {
        if (!$this->fiercePublishers->contains($fiercePublisher)) {
            ...
            $fiercePublisher->addWonderfullBook($this);
        }
        return $this;
    }
    ...
    public function removeFiercePublisher(FiercePublisher $fiercePublisher): static
    {
        if ($this->fiercePublishers->removeElement($fiercePublisher)) {
            $fiercePublisher->removeWonderfullBook($this);
        }
        return $this;
    }
