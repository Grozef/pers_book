...
/**
 * Repository for FiercePublisher entity.
 */
class FiercePublisherRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, FiercePublisher::class);
    }

    /**
     * Find publishers with pagination and optional search term.
     *
