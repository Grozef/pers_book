...
<template>
  <b-modal v-model="show" title="Formulaire Livre" @hide="close">
    <b-form @submit.prevent="save">
      ...
      <b-form-group label="ISBN">
        <b-form-input v-model="form.isbn"></b-form-input>
      </b-form-group>
...
export default {
  ...
  async mounted() {
    if (this.book) {
      this.form = { ...this.book, publisherIds: this.book.publisherIds || [] }
    }
